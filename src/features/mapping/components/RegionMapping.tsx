...
export const RegionMapping: React.FC<RegionMappingProps> = ({
  ...
  // Note: Data reloading is handled by the hook's internal useEffect that watches showAllCategories
          ...
          <div className="w-full bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <BaseMappingHeader
              ...
              onToggleCategoryFilter={() => {
                ...
                console.log('🔍 RegionMapping: Toggling showAllCategories from', showAllCategories, 'to', newValue);
                setShowAllCategories(newValue);
                // Data will reload via useEffect in useRegionMappingData hook
              }}

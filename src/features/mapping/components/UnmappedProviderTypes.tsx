...
export const UnmappedProviderTypes: React.FC<UnmappedProviderTypesProps> = ({
  ...
  const visibleSurveys = Array.from(providerTypesBySurvey.entries()).filter(
    ...
    <>
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          {onClearSelection && selectedProviderTypes.length > 0 && (
            <div className="relative group">
              <button
      ...
      {/* Provider Types Grid - Intelligent flexible layout that adapts to any number of columns */}
      ...
      <div className="w-full overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          {visibleSurveys.map(([source, providerTypes]) => {

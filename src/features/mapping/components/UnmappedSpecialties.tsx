...
export const UnmappedSpecialties: React.FC<UnmappedSpecialtiesProps> = ({
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-2">
            ...
            {onToggleProviderTypeFilter && (
              <div className="relative group">
                <button
                  onClick={onToggleProviderTypeFilter}
                  ...
                  aria-label={showAllProviderTypes ? 'Show all survey types' : 'Filter by Data View'}
                >
                  {showAllProviderTypes ? (
            ...
            {onClearSelection && selectedSpecialties.length > 0 && (
              <div className="relative group">
                <button
      ...
      {/* Columns automatically fit within viewport width without horizontal scrolling */}
      {/* Uses flexbox for responsive column sizing */}
      <div className="w-full pb-2">
        <div className="flex flex-col sm:flex-row gap-4">
          {/* Responsive: On mobile (flex-col), vertical stack; on larger screens (sm:flex-row), horizontal row */}
          ...
          {Array.from(specialtiesBySurvey.entries()).map(([source, specialties]) => {
            ...
            return (
              <Paper 
                key={source} 
                className="p-3 relative overflow-hidden flex-1 border border-gray-200"
                style={{ 
                  minWidth: '280px'
                }}
              >

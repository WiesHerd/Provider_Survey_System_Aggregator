          ...
          <div className="w-full bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <SpecialtyMappingHeader
              ...
              onToggleProviderTypeFilter={() => {
                const newValue = !showAllProviderTypes;
                console.log('🔍 SpecialtyMapping: Toggling showAllProviderTypes from', showAllProviderTypes, 'to', newValue);
                setShowAllProviderTypes(newValue);
              }}
            ...
            <SpecialtyMappingContent
              ...
              onToggleProviderTypeFilter={() => {
                const newValue = !showAllProviderTypes;
                console.log('🔍 SpecialtyMapping Content: Toggling showAllProviderTypes from', showAllProviderTypes, 'to', newValue);
                setShowAllProviderTypes(newValue);
              }}
              // Mapped props

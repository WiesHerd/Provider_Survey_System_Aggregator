          ...
          <div className="w-full bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <BaseMappingHeader
              ...
              onToggleCategoryFilter={() => {
                ...
                console.log('🔍 ProviderTypeMapping: Toggling showAllCategories from', showAllCategories, 'to', newValue);
                setShowAllCategories(newValue);
                // Data will reload via useEffect in useProviderTypeMappingData hook
              }}

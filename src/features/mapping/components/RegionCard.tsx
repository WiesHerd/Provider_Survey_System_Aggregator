 ...
 * 
 * @param region - The unmapped region to display
 * @param isSelected - Whether the region is currently selected
 * @param onSelect - Callback when the region is clicked
 */

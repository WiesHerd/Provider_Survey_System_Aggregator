  ...
  return (
    <AnalyticsErrorBoundary>
      <div className="flex flex-col space-y-6">
        ...
        {/* Background extends to cover PageHeader white space on right */}
        <div className="relative -mx-8 -mt-6 bg-gray-50">
          <div className="flex items-center justify-end w-full px-8 pr-24 py-4">
            <SavedViews
              filters={filters}

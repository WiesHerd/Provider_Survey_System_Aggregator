      ...
      <div className="border-t border-gray-200 pt-4">
        <FormControl fullWidth size="small">
          <Autocomplete
            ...
            slotProps={{
              popper: {
                placement: 'bottom-start', // Google-style: anchor to input's left edge
                modifiers: [
                  {
                    name: 'offset',
                    options: {
                      offset: [0, 4], // Small gap below input
                    },
                  },
                  {
                ...
                sx: {
                  zIndex: 1300, // Ensure proper layering
                  '& .MuiAutocomplete-paper': {
                    maxWidth: '400px !important', // Constrain dropdown width
